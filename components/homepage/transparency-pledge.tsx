      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <FadeIn delay={0.2}>
            <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
              Every participating agency and registered candidate signs this covenant before gaining platform access. Zero exceptions.
            </p>
          </FadeIn>
        </div>

        <FadeIn stagger={0.12} className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <span className="flex size-8 items-center justify-center rounded-lg bg-primary/10 text-primary font-heading font-bold text-xs">
                    0{idx + 1}
                  </span>
                ...
                <h3 className="font-heading text-lg sm:text-xl font-bold mb-2 text-foreground">
                  {pledge.title}
                </h3>
        ...
        <FadeIn delay={0.4} className="mt-12 text-center">
          <div className="inline-flex items-center gap-2 text-xs font-medium text-muted-foreground bg-background px-4 py-2 rounded-full border border-border/60 shadow-xs">
            ...
            <span>Audited weekly by WrongFit Quality Council</span>
          </div>
        </FadeIn>
      </div>
    </section>
